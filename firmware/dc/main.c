...
void main(void){
	...
	while(1){
		...
		if((adcChannels.nXPanelCurrent + adcChannels.nYPanelCurrent + adcChannels.pXPanelCurrent + adcChannels.pYPanelCurrent + adcChannels.pZPanelCurrent)*panelCurrentUnit < 0.03 &
				(adcChannels.nXPanelVoltage + adcChannels.nYPanelVoltage + adcChannels.pXPanelVoltage + adcChannels.pYPanelVoltage + adcChannels.pZPanelVoltage)*panelVoltageUnit < 3){
